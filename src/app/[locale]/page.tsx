  ...
  return (
    <>
      ...
      <section className="relative min-h-[88vh] overflow-hidden bg-ink text-sand">
        ...
        <div className="container relative px-4 sm:px-6 lg:px-10 xl:px-14 flex min-h-[88vh] flex-col justify-center py-16 sm:py-20">
      ...
      {isLoggedIn && (
      <section id="categories" className="container px-4 sm:px-6 lg:px-10 xl:px-14 py-14 sm:py-16 lg:py-20">
      ...
      {isLoggedIn && tournaments?.length ? (
        <section id="featured-tournaments" className="container px-4 sm:px-6 lg:px-10 xl:px-14 py-14 sm:py-16 lg:py-20">
      ...
      <section id="courses" className="container px-4 sm:px-6 lg:px-10 xl:px-14 py-14 sm:py-16 lg:py-20">
      ...
      <section id="distances" className="border-y border-border bg-muted/30">
        <div className="container px-4 sm:px-6 lg:px-10 xl:px-14 py-14 sm:py-16 lg:py-20">
      ...
      {isLoggedIn && (
      <section className="container px-4 sm:px-6 lg:px-10 xl:px-14 py-14 sm:py-16 lg:py-20">
      ...
      <section className="relative overflow-hidden bg-ink py-16 sm:py-20 lg:py-24 text-center text-sand">
        ...
        <div className="container relative px-4 sm:px-6 lg:px-10 xl:px-14">
